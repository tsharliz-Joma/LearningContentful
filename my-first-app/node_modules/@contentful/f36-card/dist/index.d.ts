...
declare const AssetCard: ({ actions, className, icon, isSelected, size, src, status, title, type, withDragHandle, isLoading, testId, ...otherProps }: AssetCardInternalProps) => JSX.Element;
...
declare type EntryCardInternalProps = Omit<BaseCardInternalProps, 'badge' | 'header' | 'padding' | 'ref' | 'type' | 'title'> & {
    /**
