...
declare type TooltipPlacement = Placement;
...
declare const Tooltip: ({ children, className, as: HtmlTag, content, id, isVisible, hideDelay, onBlur, onFocus, onMouseLeave, onMouseOver, onKeyDown, showDelay, targetWrapperClassName, maxWidth, testId, placement, usePortal, isDisabled, ...otherProps }: TooltipProps) => JSX.Element;
