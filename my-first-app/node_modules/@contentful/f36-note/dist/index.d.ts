...
declare type NoteVariant = 'negative' | 'positive' | 'primary' | 'warning' | 'neutral';
 ...
 */
declare const Note: React.ForwardRefExoticComponent<Omit<Omit<Pick<React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement>, "key" | keyof React.HTMLAttributes<HTMLElement>>, never>, "title" | "children" | keyof CommonProps | "variant" | "withCloseButton" | "onClose"> & CommonProps & {
    /**
     * Determines style variation of Note component
     */
    variant?: NoteVariant;
