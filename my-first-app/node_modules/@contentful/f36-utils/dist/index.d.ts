...
declare function Portal({ children, container: containerElement, }: PortalProps): React.ReactPortal | null;
 ...
 * })
 */
declare const useKeyboard: (props: UseKeyboardProps) => void;
 ...
 * @param match
 */
declare function getStringMatch(base: string, match: string): MatchObj;
