...
declare type MenuSectionTitleProps = SectionHeadingProps;
declare const MenuSectionTitle: (props: ExpandProps<MenuSectionTitleProps>) => JSX.Element;

declare type SubmenuProps = Omit<MenuProps, 'placement' | 'offset' | 'usePortal' | 'isOpen' | 'isAutoalignmentEnabled' | 'defaultIsOpen'>;
